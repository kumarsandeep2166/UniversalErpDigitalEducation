# Generated by Django 2.1.2 on 2019-07-15 04:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enrollment_number', models.CharField(blank=True, default='WERCF23BH', max_length=20, unique=True)),
                ('date_of_admission', models.DateField(blank=True, default='2019-25-6', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_pic', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_tenth', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_twelth', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_degree', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_clc', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_conduct_certificate', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_migration', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_birth_certificate', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_address', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_thumb', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('student_signature', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('tenth_marksheet', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('tewlth_marksheet', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
                ('degree_marksheet', models.ImageField(blank=True, upload_to=student.models.PathAndRename('documents/2019/07/15'))),
