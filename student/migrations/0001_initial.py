# Generated by Django 2.1.2 on 2019-08-06 05:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_pic', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_tenth', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_twelth', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_degree', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_clc', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_conduct_certificate', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_migration', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_birth_certificate', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_address', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_thumb', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('student_signature', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('tenth_marksheet', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('tewlth_marksheet', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
                ('degree_marksheet', models.ImageField(blank=True, null=True, upload_to=student.models.PathAndRename('documents/2019/08/06'))),
