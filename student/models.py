...
class Student(models.Model):
    ...
    student_pic=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_tenth=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_twelth=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_degree=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_clc=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_conduct_certificate=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_migration=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_birth_certificate=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_address=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_thumb=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    student_signature=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    tenth_marksheet=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
    tewlth_marksheet=models.ImageField(upload_to=PathAndRename(image_path),blank=True)
